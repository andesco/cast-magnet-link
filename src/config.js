...
// Pre-build a config for the Node.js environment
// NOTE: This is commented out for Cloudflare Workers compatibility
// Cloudflare Workers don't have process.env at module load time
// export const nodeConfig = getConfig(process.env);